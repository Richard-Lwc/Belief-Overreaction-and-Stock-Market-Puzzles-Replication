...
est store m4
reg2docx m1 m2 m3 m4 using table9_panelA.docx, se(%9.4f) b(%9.4f) scalars(N r2_a) replace noconstant

reg std_HML_1_5 std_delta_LTG std_lag_LTG std_Mkt_1_5
reg std_RMW_1_5 std_delta_LTG std_lag_LTG std_Mkt_1_5
reg std_CMA_1_5 std_delta_LTG std_lag_LTG std_Mkt_1_5
reg std_SMB_1_5 std_delta_LTG std_lag_LTG std_Mkt_1_5
// Panel B
...
est store m4
reg2docx m1 m2 m3 m4 using table9_panelB.docx, se(%9.4f) b(%9.4f) scalars(N r2_a) replace noconstant note(*: p < 0.1  **: p < 0.05  ***: p < 0.01)

reg std_f_HML std_delta_LTG std_lag_LTG
reg std_f_RMW std_delta_LTG std_lag_LTG
reg std_f_CMA std_delta_LTG std_lag_LTG
reg std_f_SMB std_delta_LTG std_lag_LTG
