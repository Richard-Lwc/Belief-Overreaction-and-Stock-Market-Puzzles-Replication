1. Aggregate level and firm level data.R: for calculating all aggregate level as well as firm level statistics, e.g., LTG, forecast errors, including FF5 grouping and returns.
2. Cumulative return and FF5 ranking.ipynb: for calculating 1-year, 3-year and 5-year cumulative return of aggregate, firm and decile portfolios as well as FF5 ranking.
