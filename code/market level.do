...
newey std_delta_LTG std_lag_LTG std_e_cae std_SVIX, lag(12)
est store m6
reg2docx m1 m2 m3 m4 m5 m6 using table3.docx, se(%9.4f) b(%9.4f) scalars(N r2_a) replace noconstant note(*: p < 0.1  **: p < 0.05  ***: p < 0.01)
...
est store m3
reg2docx m1 m2 m3 using table8.docx, se(%9.4f) b(%9.4f) replace noconstant note(*: p < 0.1  **: p < 0.05  ***: p < 0.01)
