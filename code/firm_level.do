...
destring forecast_error, replace force
...
xtscc std_return_1_5 std_predicted_forecast_error i.Year, fe lag(60)
est store m3
xtscc std_return_1_5 std_predicted_forecast_error std_dp i.Year, fe lag(60)
est store m4
xtscc std_return_1_5 std_predicted_forecast_error std_pe i.Year, fe lag(60)
est store m5
...
reghdfe std_return_1_5 std_predicted_forecast_error, absorb(PERMNO Year)
reghdfe std_return_1_5 std_predicted_forecast_error std_dp, absorb(PERMNO Year)
reghdfe std_return_1_5 std_predicted_forecast_error std_pe, absorb(PERMNO Year)
...
xtscc std_return_1_5 std_predicted_forecast_error_2 std_dp i.Year, fe lag(60)
est store m6
xtscc std_return_1_5 std_predicted_forecast_error_2 std_pe i.Year, fe lag(60)
est store m7
...
reghdfe std_return_1_5 std_predicted_forecast_error_2 std_dp, absorb(PERMNO Year)
reghdfe std_return_1_5 std_predicted_forecast_error_2 std_pe, absorb(PERMNO Year)